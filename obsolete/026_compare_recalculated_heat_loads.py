...
parser.add_argument('--avg-time', help='[h] Time where to take histograms', type=float)
...
fill_dict = {}
data_folder_list = ['./', '/afs/cern.ch/project/spsecloud/LHC_2015_PhysicsAfterTS2/' , '/afs/cern.ch/project/spsecloud/LHC_2015_IntRamp25ns/', '/afs/cern.ch/work/l/lhcscrub/LHC_2017_operation']
...
if args.avg_time:
    avg_time_hrs = args.avg_time


try:
    fill_dict.update(tm.parse_timber_file(data_folder+'/fill_bunchbybunch_data_csvs/bunchbybunch_data_fill_%d.csv' % filln, verbose=False))
except Exception as e:
    print e
    pass

if not args.nolog:
    fill_dict.update(tm.parse_timber_file(data_folder+'./fill_heatload_data_csvs/heatloads_fill_%d.csv' % filln, verbose=False))
